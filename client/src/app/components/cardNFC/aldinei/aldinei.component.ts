...
@Component({
  selector: 'app-aldinei',
  standalone: true,
  imports: [CommonModule],
  templateUrl: './aldinei.component.html',
  styleUrl: './aldinei.component.scss'
})
export class AldineiComponent {

  contact = {
    nome: 'Aldinei Franklin',
    telefone: '+5531993927236',
    email: 'aldinei@aldiweb.com.br',
    website: 'https://www.aldiweb.com.br',
    linkedIn: 'https://www.linkedin.com/in/aldinei-franklin/?trk=opento_sprofile_details',
    org: 'Aldinei Franklin'
  };

  shareData = {
    title: 'Aldinei Franklin - CEO AldiWeb',
    text: 'Conheça o perfil do Aldinei Franklin!',
