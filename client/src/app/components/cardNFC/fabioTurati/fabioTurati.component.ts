...
@Component({
  selector: 'app-fabio-turati',
  standalone: true,
  imports: [],
  templateUrl: './fabioTurati.component.html',
  styleUrl: './fabioTurati.component.scss'
})
export class FabioTuratiComponent {

  contact = {
    nome: 'Fabio Turati',
    telefone: '+5562992945627',
    email: 'fabio.cturati@totvs.com.br',
    website: 'totvs.com',
    linkedIn: 'https://www.linkedin.com/in/fabio-cesar-turati/',
    org: 'Fabio Turati'
  };

  shareData = {
    title: 'Fabio Turati - DIRETOR DE ATENDIMENTO',
    text: 'Conheça o perfil do Fabio Turati!',
