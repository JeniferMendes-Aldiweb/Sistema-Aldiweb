...
@Component({
  selector: 'app-fillippi',
  standalone: true,
  imports: [],
  templateUrl: './fillippi.component.html',
  styleUrl: './fillippi.component.scss'
})
export class FillippiComponent {

  contact = {
    nome: 'Fillippi Paccelli',
    telefone: '+5531982958901',
    email: 'paccielli@aldiweb.com.br',
    website: 'https://www.aldiweb.com.br',
    linkedIn: 'https://www.linkedin.com/in/fillippi/',
    org: 'Fillippi Paccelli'
  };

  shareData = {
    title: 'Fillippi Paccelli - EXECUTIVO AldiWeb',
    text: 'Conheça o perfil do Fillippi Paccelli!',
