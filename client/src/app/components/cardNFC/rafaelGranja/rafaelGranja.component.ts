...
@Component({
  selector: 'app-rafael-granja',
  standalone: true,
  imports: [],
  templateUrl: './rafaelGranja.component.html',
  styleUrl: './rafaelGranja.component.scss'
})
export class RafaelGranjaComponent {
  
  contact = {
    nome: 'Rafael Granja',
    telefone: '+5531984736960',
    email: 'rafael.francisco@aldiweb.com.br',
    website: 'https://www.aldiweb.com.br',
    linkedIn: 'https://www.linkedin.com/in/rafaelgranja/',
    org: 'Rafael Granja'
  };

  shareData = {
    title: 'Rafael Granja - CONSULTOR AldiWeb',
    text: 'Conheça o perfil do Rafael Granja!',
