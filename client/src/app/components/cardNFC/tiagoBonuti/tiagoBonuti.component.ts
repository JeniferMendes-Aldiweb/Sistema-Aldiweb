...
@Component({
  selector: 'app-tiago-bonuti',
  standalone: true,
  imports: [],
  templateUrl: './tiagoBonuti.component.html',
  styleUrl: './tiagoBonuti.component.scss'
})
export class TiagoBonutiComponent {
  ...
  shareData = {
    title: 'Tiago Bonuti',
    text: 'Conheça o perfil do Tiago Bonuti!',
