...
@Component({
  selector: 'app-wanessa',
  standalone: true,
  imports: [],
  templateUrl: './wanessa.component.html',
  styleUrl: './wanessa.component.scss'
})
export class WanessaComponent {

  contact = {
    nome: 'Wanessa Siqueira',
    telefone: '+559888630212',
    email: 'wanessa.siqueira@aldiweb.com.br',
    website: 'https://www.aldiweb.com.br',
    linkedIn: 'https://www.linkedin.com/in/wanessa-siqueira-00ab0a84/',
    org: 'Wanessa Siqueira'
  };

  shareData = {
    title: 'Wanessa Siqueira - CONSULTORA AldiWeb',
    text: 'Conheça o perfil da Wanessa Siqueira!',
