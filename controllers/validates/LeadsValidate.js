...
const registerValidate = (data) => {
    ...
    const schema = Joi.object({
        nomefantasia: Joi.string().required().max(100),
        nome: Joi.string().required().max(100),
        cgccfo: Joi.string().required().max(20),        
        ...
        complemento: Joi.string().allow(null, '').max(60),
        bairro: Joi.string().allow(null, '').max(80),
        cidade: Joi.string().allow(null, '').max(32),
        codetd: Joi.string().allow(null, '').max(2),
        cep: Joi.string().allow(null, '').max(9),
        telefone: Joi.string().allow(null, '').max(15),

        ruapgto: Joi.string().allow(null, '').max(100),
        numeropgto: Joi.string().allow(null, '').max(8),
        complementopgto: Joi.string().allow(null, '').max(60),
        bairropgto: Joi.string().allow(null, '').max(80),
        cidadepgto: Joi.string().allow(null, '').max(32),
        codetdpgto: Joi.string().allow(null, '').max(2),
        ceppgto: Joi.string().allow(null, '').max(9),
        telefonepgto: Joi.string().allow(null, '').max(15),
        
        ruaentrega: Joi.string().allow(null, '').max(100),
        numeroentrega: Joi.string().allow(null, '').max(8),
        complementoentrega: Joi.string().allow(null, '').max(60),
        bairroentrega: Joi.string().allow(null, '').max(80),
        cidadeentrega: Joi.string().allow(null, '').max(32),
        codetdentrega: Joi.string().allow(null, '').max(2),
        cepentrega: Joi.string().allow(null, '').max(9),
        telefoneentrega: Joi.string().allow(null, '').max(15),
